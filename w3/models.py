...
class Project(models.Model):
    ...
    reporting_ns = models.ForeignKey(Country) # this is the national society that is reporting the project
    project_district = models.ForeignKey(District) # this is the district where the project is actually taking place
