            ...
            items.append(
                {
                    ...
                    "epi_considerations": getattr(ov, "assess_preparedness_of_country", None),
                    "climate_environmental_considerations": getattr(ov, "assess_climate_environment_of_country", None),
                    "urban_considerations": getattr(ov, "assess_urban_environment_of_country", None),
                    "migration_considerations": getattr(ov, "assess_migration_environment_of_country", None),
