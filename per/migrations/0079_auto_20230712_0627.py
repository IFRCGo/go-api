    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                default=1, on_delete=django.db.models.deletion.CASCADE, to="per.formanswer", verbose_name="answer"
            ),
        ...
        migrations.AlterField(
            ...
            name="question",
            field=models.ForeignKey(
                default=422, on_delete=django.db.models.deletion.CASCADE, to="per.formquestion", verbose_name="question"
            ),
            preserve_default=False,
        ),
        migrations.AlterField(
