...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='level',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='local_unit_level', to='local_units.localunitlevel', verbose_name='Coverage'),
        ),
        migrations.AlterField(
            model_name='localunitlevel',
            name='level',
            field=models.IntegerField(validators=[django.core.validators.MaxValueValidator(10), django.core.validators.MinValueValidator(0)], verbose_name='Coverage'),
        ),
        migrations.CreateModel(
            name='HealthData',
            fields=[
                ...
                ('focal_point_phone_number', models.CharField(blank=True, max_length=90, null=True, verbose_name='Focal point phone number')),
                ('focal_point_position', models.CharField(blank=True, max_length=90, null=True, verbose_name='Focal point position')),
                ('other_facility_type', models.CharField(blank=True, max_length=300, null=True, verbose_name='Other facility type')),
                ...
                ('affiliation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='health_affiliation', to='local_units.affiliation', verbose_name='Affiliation')),
                ...
                ('functionality', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='health_functionality', to='local_units.functionality', verbose_name='Functionality')),
                ...
                ('health_facility_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='health_facility_type', to='local_units.facilitytype', verbose_name='Health facility type')),
        ...
        migrations.AddField(
            model_name='localunit',
            name='health',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='health_data', to='local_units.healthdata', verbose_name='Health Data'),
        ),
        ...
        migrations.AddField(
            model_name='delegationoffice',
            name='visibility',
            field=models.IntegerField(choices=[(1, 'RCRC Movement'), (2, 'IFRC Secretariat'), (3, 'Public'), (4, 'IFRC and NS')], default=2, verbose_name='visibility'),
        ),
        migrations.AddField(
            model_name='localunit',
            name='visibility',
