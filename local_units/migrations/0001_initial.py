# Generated by Django 3.2.16 on 2023-01-09 22:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_loc', models.CharField(max_length=500, verbose_name='Address in local language')),
                ('address_en', models.CharField(max_length=500, verbose_name='Address in English')),
                ...
                ('focal_person_loc', models.CharField(max_length=255, verbose_name='Focal person for local language')),
                ('focal_person_en', models.CharField(max_length=255, verbose_name='Focal person for English')),
