...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='level',
            field=models.IntegerField(validators=[django.core.validators.MaxValueValidator(10), django.core.validators.MinValueValidator(0)], verbose_name='Type Code'),
        ),
        migrations.AddField(
            model_name='localunit',
            name='level',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='local_unit_level', to='local_units.localunitlevel', verbose_name='Level'),
        ),
        migrations.AddField(
            model_name='localunit',
            name='is_public',
