...
class DrefOperationalUpdateSerializer(NestedUpdateMixin, NestedCreateMixin, ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if not dref_operational_update:
            ...
            validated_data["national_society_integrity_contact_phone_number"] = dref.national_society_integrity_contact_phone_number
            ...
            validated_data["is_volunteer_team_diverse"] = dref_operational_update.is_volunteer_team_diverse
