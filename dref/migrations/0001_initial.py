    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ns_request', models.BooleanField(default=False, help_text='Has NS requested Dref?')),
                ...
                ('government_requested_assistance_date', models.DateField(blank=True, null=True, verbose_name='government requested assiatance date')),
                ...
                ('girls', models.IntegerField(blank=True, help_text='Grils under 18', null=True, verbose_name='girls')),
                ...
                ('publishing_date', models.DateField(blank=True, null=True, verbose_name='end date')),
                ...
                ('national_scoiety_contact_name', models.CharField(blank=True, max_length=255, null=True, verbose_name='national scoiety contact name')),
                ('national_scoiety_contact_email', models.CharField(blank=True, max_length=255, null=True, verbose_name='national scoiety contact email')),
