...
def _0058__update_dref_status(apps, schema_editor):
...
def _0062__update_dref(apps, schema_editor):
    Dref = apps.get_model('dref', 'Dref')
    drefs = Dref.objects.all()
    for dref in drefs:
...
def _0073__update_dref_sectors(apps, schema_editor):
...
def _0084__update_status(apps, schema_editor):
    """
...
def _0084__update_starting_language(apps, schema_editor):
    """
    Populate the starting_language field with 'en' for all existing records.
    """
    models = ['Dref', 'DrefOperationalUpdate', 'DrefFinalReport']
    for model_name in models:
        Model = apps.get_model('dref', model_name)
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('indicators', models.ManyToManyField(blank=True, to='dref.plannedinterventionindicators', verbose_name='Indicators')),
                ...
                ('narrative_description_of_achievements', models.TextField(blank=True, null=True, verbose_name='Narrative description of achievements')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anticipatory_actions', models.TextField(blank=True, help_text='Description of anticipatory actions or imminent disaster', null=True, verbose_name='anticipatory actions')),
                ...
                ('field_report', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='field_report_dref', to='api.fieldreport', verbose_name='field report')),
                ...
                ('assessment_report', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dref_assessment_report', to='dref.dreffile', verbose_name='Assessment Report')),
                ('country', models.ForeignKey(blank=True, help_text='Affected County', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dref_country', to='api.country', verbose_name='country')),
                ('district', models.ManyToManyField(blank=True, to='api.district', verbose_name='district')),
                ('is_surge_personnel_deployed', models.BooleanField(blank=True, null=True, verbose_name='Is surge personnel deployed')),
                ('risk_security', models.ManyToManyField(blank=True, to='dref.risksecurity', verbose_name='Risk Security')),
                ('is_there_major_coordination_mechanism', models.BooleanField(blank=True, null=True, verbose_name='Is major coordination mechanism')),
                ...
                ('supporting_document', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dref_supporting_document', to='dref.dreffile', verbose_name='Supporting Document')),
                ...
                ('type_of_dref', models.IntegerField(blank=True, choices=[(0, 'Imminent'), (1, 'Assessment'), (2, 'Response')], null=True, verbose_name='dref type')),
            ],
            options={
                'verbose_name': 'dref',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budget_file', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='budget_file_dref_operational_update', to='dref.dreffile', verbose_name='budget file')),
                ('cover_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cover_image_dref_operational_update', to='dref.dreffile', verbose_name='cover image')),
                ('event_description', models.TextField(blank=True, null=True, verbose_name='Event description')),
                ...
                ('photos', models.ManyToManyField(blank=True, related_name='photos_dref_operational_update', to='dref.dreffile', verbose_name='images')),
                ('assessment_report', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dref_operational_update_assessment_report', to='dref.dreffile', verbose_name='Assessment Report')),
                ('country', models.ForeignKey(blank=True, help_text='Affected County', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='operational_update_country', to='api.country', verbose_name='country')),
                ('district', models.ManyToManyField(blank=True, to='api.district', verbose_name='district')),
                ('is_there_major_coordination_mechanism', models.BooleanField(blank=True, help_text='Is there major coordinate mechanism', null=True)),
                ('is_there_un_or_other_actor', models.BooleanField(blank=True, null=True, verbose_name='Is there un_or_other_actor')),
                ('title_prefix', models.CharField(blank=True, max_length=255, null=True, verbose_name='title prefix')),
                ('anticipatory_to_response', models.TextField(blank=True, null=True, verbose_name='Please explain how is the operation is transitioning from Anticipatory to Response')),
                ('event_map', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='event_map_dref_operational_update', to='dref.dreffile', verbose_name='event map')),
                ('has_forecasted_event_materialize', models.BooleanField(blank=True, null=True, verbose_name='Has Forecasted Event Materialize')),
                ('risk_security', models.ManyToManyField(blank=True, to='dref.risksecurity', verbose_name='Risk Security')),
                ('risk_security_concern', models.TextField(blank=True, null=True, verbose_name='Risk Security Concern')),
                ('specified_trigger_met', models.TextField(blank=True, null=True, verbose_name='Specified Trigger Met')),
                ('users', models.ManyToManyField(blank=True, related_name='user_dref_operational_update', to=settings.AUTH_USER_MODEL, verbose_name='users')),
                ...
                ('total_targeted_population', models.IntegerField(blank=True, null=True, verbose_name='total targeted population')),
                ('communication', models.TextField(blank=True, help_text='Does the NS have Communications capacity?', null=True, verbose_name='organization')),
                ('human_resource', models.TextField(blank=True, help_text='how many volunteers and staff involved in the response?', null=True, verbose_name='human resource')),
                ('is_surge_personnel_deployed', models.BooleanField(blank=True, null=True, verbose_name='Is surge personnel deployed')),
                ('logistic_capacity_of_ns', models.TextField(blank=True, help_text='what is the logistics capacity of the National Society?', null=True, verbose_name='logistic capacity of ns')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('community_involved', models.TextField(blank=True, help_text='Community been involved in the analysis of the process', null=True, verbose_name='community involved')),
                ('entity_affected', models.TextField(blank=True, help_text='Protection, gender, Inclusion affected in this process', null=True, verbose_name='entity affected')),
                ('change_in_operational_strategy', models.BooleanField(default=False, verbose_name='Change in operational strategy')),
                ('change_in_operational_strategy_text', models.TextField(blank=True, null=True, verbose_name='Change in operational strategy')),
                ('women', models.IntegerField(blank=True, null=True, verbose_name='women')),
                ('men', models.IntegerField(blank=True, null=True, verbose_name='men')),
                ('girls', models.IntegerField(blank=True, help_text='Girls under 18', null=True, verbose_name='girls')),
                ('boys', models.IntegerField(blank=True, help_text='Boys under 18', null=True, verbose_name='boys')),
                ...
                ('additional_national_society_actions', models.TextField(blank=True, null=True, verbose_name='Additional National Societies Actions')),
                ('created_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_by_dref_final_report', to=settings.AUTH_USER_MODEL, verbose_name='created by')),
                ('disaster_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.disastertype', verbose_name='disaster type')),
                ('dref', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='dref.dref', verbose_name='Dref')),
                ('event_map', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='event_map_dref_final_report', to='dref.dreffile', verbose_name='event map')),
                ('modified_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='modified_by_dref_final_report', to=settings.AUTH_USER_MODEL, verbose_name='modified by')),
                ('national_society', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='national_society_final_report', to='api.country', verbose_name='national_society')),
                ('needs_identified', models.ManyToManyField(blank=True, to='dref.identifiedneed', verbose_name='needs identified')),
                ('photos', models.ManyToManyField(blank=True, related_name='photos_dref_final_report', to='dref.dreffile', verbose_name='images')),
                ('planned_interventions', models.ManyToManyField(blank=True, to='dref.plannedintervention', verbose_name='planned intervention')),
                ('is_published', models.BooleanField(default=False, verbose_name='Is Published')),
                ('number_of_people_affected', models.IntegerField(blank=True, null=True, verbose_name='number of people affected')),
                ('assessment_report', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dref_final_report_assessment_report', to='dref.dreffile', verbose_name='Assessment Report')),
                ('country', models.ForeignKey(blank=True, help_text='Affected County', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='final_report_country', to='api.country', verbose_name='country')),
                ('district', models.ManyToManyField(blank=True, to='api.district', verbose_name='district')),
                ('title_prefix', models.CharField(blank=True, max_length=255, null=True, verbose_name='title prefix')),
                ('cover_image', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cover_image_dref_final_report', to='dref.dreffile', verbose_name='cover image')),
                ('images', models.ManyToManyField(blank=True, related_name='image_dref_final_report', to='dref.dreffile', verbose_name='images')),
                ('is_assessment_report', models.BooleanField(blank=True, null=True, verbose_name='Is assessment Report')),
                ('is_there_major_coordination_mechanism', models.BooleanField(blank=True, help_text='Is there major coordinate mechanism', null=True)),
                ('risk_security', models.ManyToManyField(blank=True, to='dref.risksecurity', verbose_name='Risk Security')),
                ('risk_security_concern', models.TextField(blank=True, null=True, verbose_name='Risk Security Concern')),
                ('total_targeted_population', models.IntegerField(blank=True, null=True, verbose_name='total targeted population')),
                ('users', models.ManyToManyField(blank=True, related_name='user_dref_final_report', to=settings.AUTH_USER_MODEL, verbose_name='users')),
                ('event_date', models.DateField(blank=True, help_text='Date of event/Approximate date of impact', null=True, verbose_name='event date')),
                ('national_society_actions', models.ManyToManyField(blank=True, to='dref.nationalsocietyaction', verbose_name='national society actions')),
                ('people_in_need', models.IntegerField(blank=True, null=True, verbose_name='people in need')),
                ('did_national_society', models.BooleanField(blank=True, null=True, verbose_name='Did National Society')),
                ('event_text', models.TextField(blank=True, null=True, verbose_name='event text')),
                ('ns_respond_date', models.DateField(blank=True, help_text='NS anticipatory actions started/NS response', null=True, verbose_name='ns respond date')),
                ('financial_report', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='financial_report_dref_final_report', to='dref.dreffile', verbose_name='financial report')),
                ('financial_report_description', models.TextField(blank=True, null=True, verbose_name='Financial Report Description')),
                ('has_national_society_conducted', models.BooleanField(blank=True, null=True, verbose_name='Has national society conducted any intervention')),
                ('national_society_conducted_description', models.TextField(blank=True, null=True, verbose_name='National Society conducted description')),
                ('num_assisted', models.IntegerField(blank=True, null=True, verbose_name='number of assisted')),
            ],
            options={
        ...
        migrations.RunSQL(
            sql=['update dref_dref set type_of_dref = 2', 'update dref_dref set type_of_dref = 0 where type_of_onset=0', 'update dref_dref set type_of_dref = 1 where is_assessment_report'],
        ...
        migrations.RunSQL(
            sql=['update dref_drefoperationalupdate set type_of_dref = 2', 'update dref_drefoperationalupdate set type_of_dref = 0 where type_of_onset=0', 'update dref_drefoperationalupdate set type_of_dref = 1 where is_assessment_report'],
        ...
        migrations.RunSQL(
            sql=['update dref_dreffinalreport set type_of_dref = 2', 'update dref_dreffinalreport set type_of_dref = 0 where type_of_onset=0', 'update dref_dreffinalreport set type_of_dref = 1 where is_assessment_report'],
        ...
        migrations.RunPython(
            code=_0058__update_dref_status,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dref_disaster_category_file', to='dref.dreffile', verbose_name='If available please upload Disaster categorization Analysis'),
        ),
        migrations.AddField(
            model_name='dref',
            name='has_child_safeguarding_risk_analysis_assessment',
            field=models.BooleanField(blank=True, null=True, verbose_name='Has the child safeguarding risk analysis assessment been completed?'),
        ),
        migrations.AddField(
            model_name='dreffinalreport',
            name='has_child_safeguarding_risk_analysis_assessment',
        ...
        migrations.RunPython(
            code=_0073__update_dref_sectors,
            reverse_code=django.db.migrations.operations.special.RunPython.noop,
        ),
        migrations.AddField(
            model_name='dreffinalreport',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dref_contingency_plans_supporting_document', to='dref.dreffile', verbose_name='Contingency Plans Supporting Document'),
        ),
        migrations.AddField(
            model_name='dref',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dref_scenario_supporting_document', to='dref.dreffile', verbose_name='Scenario Analysis Supporting Document'),
        ),
        migrations.AddField(
            model_name='dref',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('proposed_type', models.PositiveIntegerField(choices=[(1, 'Early Actions'), (2, 'Early Response')], verbose_name='dref proposed action')),
                ('total_budget', models.PositiveIntegerField(blank=True, null=True, verbose_name='Total Purpose Action Budget')),
            ],
        ),
        migrations.AddField(
            model_name='dref',
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(blank=True, default=False, help_text='Did you complete the child safeguarding risk analysis', null=True),
        ),
        migrations.AddField(
            model_name='dref',
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(blank=True, null=True, verbose_name='Has prevention of sexual exploitation and abuse policy'),
        ),
        migrations.AddField(
            model_name='dref',
        ...
        migrations.AddField(
            ...
            field=models.TextField(blank=True, help_text='Does your volunteer team reflect the gender, age, and cultural diversity of the people you’re helping?', null=True, verbose_name='is volunteer team diverse'),
        ),
        migrations.AddField(
            model_name='dref',
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, max_length=255, null=True, verbose_name='national society integrity contact email'),
        ),
        migrations.AddField(
            model_name='dref',
        ...
        migrations.AddField(
            ...
            field=models.CharField(blank=True, max_length=100, null=True, verbose_name='national society integrity contact phone number'),
        ),
        migrations.AddField(
            model_name='dref',
            name='national_society_integrity_contact_title',
            field=models.CharField(blank=True, max_length=255, null=True, verbose_name='national society integrity contact title'),
        ),
        migrations.AddField(
            model_name='dreffinalreport',
            name='estimated_number_of_affected_female',
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(default=False, help_text='Is this DREF Imminent V2? If yes, it will be used for the new dref imminent type.', verbose_name='Is DREF Imminent V2?'),
        ),
        migrations.AddField(
            model_name='dref',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sector', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='deployments.sector', verbose_name='Sector Tag')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.PositiveIntegerField(blank=True, help_text='Total expenditure for the proposed action', null=True, verbose_name='Expenditure'),
        ),
        migrations.AddField(
            model_name='dreffinalreport',
        ...
        migrations.RunPython(
            code=_0084__update_starting_language,
            reverse_code=django.db.migrations.operations.special.RunPython.noop,
        ),
        migrations.AddField(
            model_name='dreffinalreport',
        ...
        migrations.AddField(
            model_name='dref',
            name='glide_codes',
            field=django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=18), blank=True, default=list, size=None, verbose_name='glide number'),
        ),
        migrations.AddField(
            model_name='drefoperationalupdate',
            name='glide_codes',
