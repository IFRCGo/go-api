        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("approved", "Approved"), ("in_process", "In Process")],
                        default=eap.models.EAP.Status("in_process"),
                        max_length=255,
                ...
                (
                    ...
                    models.IntegerField(blank=True, null=True, verbose_name="Pre-positioning Budget (CHF)"),
                ),
                ...
                (
                    "nsc_phone",
                    models.CharField(blank=True, max_length=255, null=True, verbose_name="National Society Contact Phone"),
                ),
                (
                    "ifrc_focal_name",
                    models.CharField(blank=True, max_length=255, null=True, verbose_name="Ifrc Focal Point Name"),
                ),
                (
                    "ifrc_focal_title",
                    models.CharField(blank=True, max_length=255, null=True, verbose_name="Ifrc Focal Point Title"),
                ),
                (
                    "ifrc_focal_email",
                    models.CharField(blank=True, max_length=255, null=True, verbose_name="Ifrc Focal Point Email"),
                ),
                (
                    "ifrc_focal_phone",
                    models.CharField(blank=True, max_length=255, null=True, verbose_name="Ifrc Focal Point Phone"),
                ),
                (
                    "country",
                    models.ForeignKey(
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="eap_disaster_type",
                        to="api.DisasterType",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default=eap.models.EarlyActionIndicator.IndicatorChoices("indicator_1"),
                        max_length=255,
                        null=True,
                        verbose_name=[("indicator_1", "Indicator 1"), ("indicator_2", "Indicator 2")],
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        choices=[
                            (0, "Shelter, Housing And Settlements"),
                            (1, "Livelihoods"),
                            (2, "Multi-purpose Cash"),
                            (3, "Health And Care"),
                            (4, "Water, Sanitation And Hygiene"),
                            (5, "Protection, Gender And Inclusion"),
                            (6, "Education"),
                            (7, "Migration"),
                            (8, "Risk Reduction, Climate Adaptation And Recovery"),
                            (9, "Community Engagement And Accountability"),
                            (10, "Environment Sustainability"),
                            (11, "Shelter Cluster Coordination"),
                        ],
                        verbose_name="sector",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "eap",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="eap_partner", to="eap.EAP", verbose_name="EAP"
                    ),
                ),
            ],
            options={
