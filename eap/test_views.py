...
class EAPFileTestCase(APITestCase):
    def setUp(self):
        ...
        self.template_url = "/api/v2/eap-file/global-files/"
    ...
    def test_get_full_eap_forecast_table_template(self):
        ...
        response = self.client.get(
            self.template_url,
            {"template_type": "full_eap_forecast_table"},
        )
        self.assert_200(response)
        self.assertIn("template_url", response.data)
    ...
    def test_get_full_eap_theory_of_change_template(self):
        ...
        response = self.client.get(
            self.template_url,
            {"template_type": "full_eap_theory_of_change_table"},
        )
        self.assert_200(response)
        self.assertIn("template_url", response.data)
