...
router.register(r'action', api_views.ActionViewset, base_name='action')
router.register(r'external_partner', api_views.ExternalPartnerViewset, base_name='external_partner')
router.register(r'supported_activity', api_views.SupportedActivityViewset, base_name='supported_activity')
router.register(r'disaster_type', api_views.DisasterTypeViewset, base_name='disaster_type')
...
router.register(r'district', api_views.DistrictViewset, base_name='district')
...
router.register(r'situation_report_type', api_views.SituationReportTypeViewset, base_name='situation_report_type')
router.register(r'appeal', api_views.AppealViewset, base_name='appeal')
router.register(r'appeal_document', api_views.AppealDocumentViewset, base_name='appeal_document')
...
router.register(r'eru', deployment_views.ERUViewset, base_name='eru')
router.register(r'featured_event_deployments', api_views.EventDeploymentsViewset, base_name='featured_event_deployments')
router.register(r'eru_owner', deployment_views.ERUOwnerViewset, base_name='eru_owner')
router.register(r'personnel_deployment', deployment_views.PersonnelDeploymentViewset, base_name='personnel_deployment')
router.register(r'personnel', deployment_views.PersonnelViewset, base_name='personnel')
router.register(r'personnel_by_event', api_views.DeploymentsByEventViewset, base_name='personnel_by_event')
router.register(r'partner_deployment', deployment_views.PartnerDeploymentViewset, base_name='pertner_deployment')
router.register(r'surge_alert', notification_views.SurgeAlertViewset, base_name='surge_alert')
