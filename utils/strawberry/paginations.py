...
class CountList(Generic[DjangoModelTypeVar]):
    ...
    queryset: strawberry.Private[
        typing.Union[
            models.QuerySet[DjangoModelTypeVar],  # type: ignore[reportGeneralTypeIssues]
            list[DjangoModelTypeVar]
        ]
    ]
...
class StrawberryDjangoCountList(StrawberryDjangoField):
    ...
    @cached_property
    def django_model(self) -> typing.Optional[type[models.Model]]:
        super().django_model
    ...
    def get_result(
        self,
        source: typing.Optional[models.Model],
        info: Any,
        args: list[Any],
        kwargs: dict[str, Any],
    ):
