...
class DjangoReversionDataFixHelperTest(TestCase):
    ...
    def test_date_fields_to_datetime(self):
        self.assert_values({"2022-01-01": 46, "2022-01-01T00:00:00": 48, None: 1})
        DjangoReversionDataFixHelper.date_fields_to_datetime(ContentType, Version, PerOverview, [self.field_name])
    ...
    def test_datetime_fields_to_date(self):
        ...
        self.assert_values({"2022-01-01": 46, "2022-01-01T00:00:00": 48, None: 1})
        DjangoReversionDataFixHelper.datetime_fields_to_date(ContentType, Version, PerOverview, [self.field_name])
