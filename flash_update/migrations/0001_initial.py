            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[
                            ("ifrc_secretariat", "IFRC Secretariat"),
                            ("rcrc_network", "RCRC Network"),
                            ("rcrc_network_and_donors", "RCRC Network and Donors"),
                        ],
                        max_length=50,
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "flash_update",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="flash_update.FlashUpdate", verbose_name="Flash update"
                    ),
                ),
            ],
            options={
