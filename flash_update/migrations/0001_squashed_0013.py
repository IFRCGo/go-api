    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organizations', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('NTLS', 'National Society'), ('PNS', 'RCRC'), ('FDRN', 'Federation'), ('GOV', 'Government')], max_length=4), blank=True, default=list, size=None, verbose_name='organizations')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', main.fields.SecureFileField(upload_to='flash_update/images', verbose_name='file')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('situational_overview_en', tinymce.models.HTMLField(blank=True, default='', null=True, verbose_name='Situational Overview')),
                ('situational_overview_es', tinymce.models.HTMLField(blank=True, default='', null=True, verbose_name='Situational Overview')),
                ('situational_overview_fr', tinymce.models.HTMLField(blank=True, default='', null=True, verbose_name='Situational Overview')),
                ('situational_overview_ar', tinymce.models.HTMLField(blank=True, default='', null=True, verbose_name='Situational Overview')),
                ...
                ('share_with', models.CharField(blank=True, choices=[('ifrc_secretariat', 'IFRC Secretariat')], default='ifrc_secretariat', max_length=50, null=True, verbose_name='share with')),
                ...
                ('extracted_file', main.fields.SecureFileField(blank=True, null=True, upload_to='flash_update/pdf/', verbose_name='extracted file')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('organization', models.CharField(choices=[('NTLS', 'National Society'), ('PNS', 'RCRC'), ('FDRN', 'Federation'), ('GOV', 'Government')], max_length=16, verbose_name='organization')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('share_with', models.CharField(choices=[('ifrc_secretariat', 'IFRC Secretariat')], default='ifrc_secretariat', max_length=50, verbose_name='share with')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('district', models.ManyToManyField(blank=True, related_name='flash_district', to='api.district', verbose_name='district')),
                ('flash_update', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='flash_country_district', to='flash_update.flashupdate', verbose_name='Flash update')),
            ],
            options={
