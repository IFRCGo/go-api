...
class InformalReferences(models.Model):
    date = models.DateTimeField(verbose_name=_('start date'), blank=True, null=True)
    source_description = models.CharField(verbose_name=_('Name or Source Discription'), max_length=225, blank=True)
