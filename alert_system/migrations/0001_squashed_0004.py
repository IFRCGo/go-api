    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_id', models.CharField(help_text='Event ID of the LoadItem.', unique=True, verbose_name='Event ID')),
                ('parent_event_id', models.CharField(help_text='Event ID without the episode number.', verbose_name='Parent event ID')),
                ...
                ('episode_number', models.IntegerField(blank=True, help_text='Episode Id of the event', null=True, verbose_name='Episode ID')),
