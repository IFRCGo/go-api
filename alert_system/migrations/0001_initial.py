# Generated by Django 4.2.26 on 2026-01-02 10:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='alert_emails', to='alert_system.loaditem')),
                ('subscription', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='email_logs', to='notifications.alertsubscription')),
