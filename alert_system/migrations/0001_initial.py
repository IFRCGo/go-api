# Generated by Django 4.2.19 on 2025-11-20 08:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection', models.CharField(help_text='Collection type of the item', verbose_name='collection type')),
                ...
                ('connector', models.ForeignKey(help_text='Data source connector', on_delete=django.db.models.deletion.CASCADE, related_name='items', to='alert_system.connector', verbose_name='Connector')),
            ],
            options={
