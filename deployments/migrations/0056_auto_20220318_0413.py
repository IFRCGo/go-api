...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='status',
            field=models.CharField(choices=[('on_going', 'Activity On-Going'), ('complete', 'Activity Complete'), ('planned', 'Planned')], default=deployments.models.EmergencyProject.ActivityStatus('on_going'), max_length=40),
        ),
    ]
