    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reporting_ns', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='api.Country', verbose_name='Reporting national society')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplies', django.contrib.postgres.fields.jsonb.JSONField(default=dict, verbose_name='supplies')),
                ('custom_action', models.CharField(blank=True, max_length=255, null=True, verbose_name='custom_action')),
                ('custom_supplies', django.contrib.postgres.fields.jsonb.JSONField(default=dict, verbose_name='custom supplies')),
