...
def _0012__update_stood_down(self, schema_editor):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rtype', models.IntegerField(choices=[(0, 'event'), (1, 'appeal'), (2, 'field report'), (3, 'surge alert'), (4, 'country'), (5, 'region'), (6, 'disaster type'), (7, 'per due date'), (8, 'followed event'), (9, 'surge deployment messages'), (10, 'surge approaching end of mission'), (11, 'weekly digest'), (12, 'new emergencies'), (13, 'new operations'), (14, 'general announcements')], default=0, verbose_name='record type')),
                ...
                ('dtype', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.disastertype', verbose_name='disaster type')),
                ...
                ('event', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='api.event', verbose_name='event')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api_guid', models.CharField(help_text='Can be used to do a GET request to check on the email sender API side.', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('atype', models.IntegerField(choices=[(0, 'fact'), (1, 'SIMS'), (2, 'ERU'), (3, 'DHEOPS'), (4, 'HEOPS'), (5, 'surge'), (6, 'rapid response')], default=0, verbose_name='alert type')),
                ('category', models.IntegerField(choices=[(0, 'information'), (1, 'deployment'), (2, 'alert'), (3, 'shelter'), (4, 'stand down')], default=0, verbose_name='category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('countries', models.ManyToManyField(blank=True, related_name='alert_subscriptions_countries', to='api.country', verbose_name='Countries')),
