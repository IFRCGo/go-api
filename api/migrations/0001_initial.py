    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bulletin', models.IntegerField(default=0, choices=api.models.Request.choices)),
                ('dref', models.IntegerField(default=0, choices=api.models.Request.choices)),
                ('dref_amount', models.IntegerField(blank=True, null=True)),
                ('appeal', models.IntegerField(default=0, choices=api.models.Request.choices)),
                ('appeal_amount', models.IntegerField(blank=True, null=True)),
                ('rdrt', models.IntegerField(default=0, choices=api.models.Request.choices)),
                ('num_rdrt', models.IntegerField(blank=True, null=True)),
                ('fact', models.IntegerField(default=0, choices=api.models.Request.choices)),
                ('num_fact', models.IntegerField(blank=True, null=True)),
                ('ifrc_staff', models.IntegerField(default=0, choices=api.models.Request.choices)),
                ('num_ifrc_staff', models.IntegerField(blank=True, null=True)),
                ('eru_base_camp', models.IntegerField(default=0, choices=api.models.Request.choices)),
                ('eru_base_camp_units', models.IntegerField(blank=True, null=True)),
                ('eru_basic_health_care', models.IntegerField(default=0, choices=api.models.Request.choices)),
                ('eru_basic_health_care_units', models.IntegerField(blank=True, null=True)),
                ('eru_it_telecom', models.IntegerField(default=0, choices=api.models.Request.choices)),
                ('eru_it_telecom_units', models.IntegerField(blank=True, null=True)),
                ('eru_logistics', models.IntegerField(default=0, choices=api.models.Request.choices)),
                ('eru_logistics_units', models.IntegerField(blank=True, null=True)),
                ('eru_deployment_hospital', models.IntegerField(default=0, choices=api.models.Request.choices)),
                ('eru_deployment_hospital_units', models.IntegerField(blank=True, null=True)),
                ('eru_referral_hospital', models.IntegerField(default=0, choices=api.models.Request.choices)),
                ('eru_referral_hospital_units', models.IntegerField(blank=True, null=True)),
                ('eru_relief', models.IntegerField(default=0, choices=api.models.Request.choices)),
                ('eru_relief_units', models.IntegerField(blank=True, null=True)),
                ('eru_water_sanitation_15', models.IntegerField(default=0, choices=api.models.Request.choices)),
                ('eru_water_sanitation_15_units', models.IntegerField(blank=True, null=True)),
                ('eru_water_sanitation_40', models.IntegerField(default=0, choices=api.models.Request.choices)),
                ('eru_water_sanitation_40_units', models.IntegerField(blank=True, null=True)),
                ('eru_water_sanitation_20', models.IntegerField(default=0, choices=api.models.Request.choices)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.IntegerField(choices=api.models.RegionName.choices)),
            ],
            options={
                'ordering': ('name',),
            },
