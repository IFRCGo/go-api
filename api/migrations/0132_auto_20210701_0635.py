    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_fr', models.TextField(null=True, verbose_name='description')),
                ('description_ar', models.TextField(null=True, verbose_name='description')),
                ('thumbnail', models.ImageField(help_text='Please maintain aspect ratio (3:4) of image while uploading', upload_to='event-featured-documents/thumbnail/', verbose_name='thumbnail')),
