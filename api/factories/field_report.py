...
from .. import models
from . import country, disaster_type, district, region, event
...
class FieldReportFactory(factory.django.DjangoModelFactory):
    ...
    start_date = fuzzy.FuzzyDateTime(datetime.datetime(2008, 1, 1, tzinfo=pytz.utc))  # start_date is now what the user explicitly sets while filling the Field Report form.
