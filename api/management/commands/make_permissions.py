...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for country in countries:
            ...
            group, created = Group.objects.get_or_create(name="%s Admins" % country.name)
        ...
        for region in regions:
            ...
            # If it's a new permission, create a group for it
            group, created = Group.objects.get_or_create(name="%s Regional Admins" % region.name)
            group.permissions.add(permission)
        ...
        ifrc_group, group_created = Group.objects.get_or_create(name="IFRC Admins")
