...
from api.models import AppealDocumentType, AppealType, Appeal, AppealFilter, Region, Country, DisasterType, Event, CronJobStatus, GECCode
...
class Command(BaseCommand):
    ...
    def parse_appeal_record(self, r, **options):
        ...
        if detail1['APD_modifyTime'] > r['APP_modifyTime']:
            modify_time = self.parse_date(detail1['APD_modifyTime'])
        else:
        ...
        fields = {
            ...
            'end_date': end_date,
            'num_beneficiaries': detail1['APD_noBeneficiaries'],
