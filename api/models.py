...
class FieldReport(models.Model):
    ...
    request_assistance = models.NullBooleanField(verbose_name=_('request assistance'))
    ns_request_assistance = models.NullBooleanField(verbose_name=_('NS request assistance'))
